...
구독 중인 텔레그램 주식방들의 **지난 24시간을 하나로 정리해서**, 매일 오전 내 텔레그램
...
매일 오전, 텔레그램 **'저장된 메시지'** 로 브리핑 4통이 옵니다.
...
### ① 브리핑은 **오전 중**에 옵니다 — 정확한 시각은 보장되지 않습니다

GitHub의 예약 실행은 밀립니다. **실측으로 35분에서 2시간 38분까지** 차이가 났습니다.
같은 설정인데도 그렇습니다.

**대신 내용은 빠지지 않습니다.** 읽어오는 구간이 아침 8시 경계로 고정돼 있어서,
실행이 늦어도 읽는 범위는 똑같습니다. **늦게 오는 것뿐이고 누락되는 것은 없습니다.**

장 시작 전에 반드시 받아야 하는 용도로는 맞지 않습니다.
